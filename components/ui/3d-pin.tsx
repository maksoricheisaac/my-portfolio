    ...
    >
      <div className="w-full h-full -mt-7 flex-none inset-0">
        ...
        {[...Array(2)].map((_, index) => (
          <motion.div
            key={index}
            className={`absolute right-1/2 bottom-1/2 bg-gradient-to-b from-transparent to-cyan-500 translate-y-[14px] w-px h-20 group-hover/pin:h-40 ${index === 1 ? 'blur-[2px]' : ''}`}
          />
        ))}
